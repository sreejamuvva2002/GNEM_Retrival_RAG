...
- Do NOT use exact_lookup for follow-up questions referring to a previous list of companies (e.g. "what about their product category", "which of these..."). Use structured_sql instead.
