...
Usage:
  ...
  venv\\Scripts\\python -m core_agent.embedding_pipeline --companies-only

  # Embed everything:
  venv\\Scripts\\python -m core_agent.embedding_pipeline

  # Embed for a specific company:
  venv\\Scripts\\python -m core_agent.embedding_pipeline --company "Hanwha Q Cells"

  # Re-embed (overwrite existing):
  venv\\Scripts\\python -m core_agent.embedding_pipeline --reembed
"""
...
from embeddings_store.doc_embedder import embed_chunks, verify_ollama_embed
