...
REBUILD_COMMAND = "python -m core_agent.embedding_pipeline --companies-only --reembed"
...
def audit_company_index(
    ...
    if qdrant_records is None:
        from embeddings_store.vector_store import get_collection_name, scroll_points
