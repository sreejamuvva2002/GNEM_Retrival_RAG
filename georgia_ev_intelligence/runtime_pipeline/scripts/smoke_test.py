...
from georgia_ev_intelligence.runtime_pipeline.evaluation.evaluator import load_qa, token_f1
...
def _save_excel(rows: list[dict]) -> Path:
    ...
    df = pd.DataFrame(rows, columns=[
        ...
        "LLM Guesses on Ambiguous Words",
...
def main():
    ...
    for i, q in enumerate(QUESTIONS, 1):
        ...
        excel_rows.append({
            ...
            "LLM Guesses on Ambiguous Words": _format_mapped_phrases(result),
